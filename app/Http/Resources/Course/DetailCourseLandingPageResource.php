...
class DetailCourseLandingPageResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'id' => $this->id,
            'user_course' => $user ? UserCourseResource::make($userCource) : null,
            'completed' => $completed,
            ...
            'modules' => ModuleDetailCourseResource::collection($this->modules),
            'course_reviews' => CourseReviewDetailCourseResource::collection($this->courseReviews),
